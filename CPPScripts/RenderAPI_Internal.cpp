...
void RenderAPI::CreateVkInstance()
{
...
void RenderAPI::CreateDebugMessenger()
{
...
void RenderAPI::CreatePhysicalDevice()
{
    // 获取当前设备支持Vulkan的显卡数量
...
vector<const char*> RenderAPI::GetRequiredExtensions()
{
...
VkResult RenderAPI::CreateDebugUtilsMessengerEXT(const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger)
{
...
void RenderAPI::DestroyDebugUtilsMessengerEXT(VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks* pAllocator)
{
...
bool RenderAPI::IsPhysicalDeviceSuitable(VkPhysicalDevice device)
{
...
QueueFamilyIndices RenderAPI::GetQueueFamilyIndices(VkPhysicalDevice device)
{
...
bool RenderAPI::CheckDeviceExtensionSupport(VkPhysicalDevice device) {
    // 获取物理设备支持的扩展数量
...
SwapChainSupportDetails RenderAPI::GetSwapChainSupportDetails(VkPhysicalDevice device)
{
...
VkSampleCountFlagBits RenderAPI::GetMaxUsableSampleCount()
{
...
VkSurfaceFormatKHR RenderAPI::ChooseSwapSurfaceFormat(const vector<VkSurfaceFormatKHR>& availableFormats)
{
...
VkPresentModeKHR RenderAPI::ChooseSwapPresentMode(const vector<VkPresentModeKHR> availablePresentModes) {
    // 在Vulkan中有四个模式可以使用:
